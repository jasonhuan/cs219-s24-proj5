...
mp_solver_gpufit: thread_pool.o
	/usr/bin/c++ -O3 -DNDEBUG -std=gnu++14 mp_solver.cpp thread_pool.o -o ./mp_solver -Wl,-rpath,/home/shared/gpufit-build/Gpufit /usr/local/lib/libGpufit.so /usr/lib/x86_64-linux-gnu/libcudart_static.a -ldl /usr/lib/x86_64-linux-gnu/librt.a -lgsl -lm -lgslcblas
