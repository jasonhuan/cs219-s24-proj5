...
void test_gpufit(std::vector<float> _initial_parameters, std::vector<float> _initial_data, std::vector<float> _output_parameters)
{
	...
	*/
	...
	// initial parameters
	std::vector< REAL > initial_parameters(n_fits * n_model_parameters); //replace: initial paths (data struct placeholder): _initial_parameters

	// data
	std::vector< REAL > data(n_points_per_fit * n_fits); //replace: .csv input values: _initial_data
	...
	// output parameters
	std::vector< REAL > output_parameters(n_fits * n_model_parameters); //replace: output _Complex variable array: _output_parameters
